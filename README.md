...
- `--artic_iupac_min_af` (default: `0.30`): Lower AF bound for converting mixed sites to IUPAC ambiguity codes in final ARTIC consensus.
- `--artic_iupac_max_af` (default: `0.70`): Upper AF bound for converting mixed sites to IUPAC ambiguity codes in final ARTIC consensus.
